...
project = 'Menards Capital One Card Activation'
copyright = '2025, Menards'
...
# Basic page info
html_title = "Activating Menards Capital One Card – Complete Guide"
html_short_title = "Menards Card Activation"
